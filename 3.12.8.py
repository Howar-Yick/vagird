...
#
# 更新日志 (v3.12.8):
# 1. 【热修复】修复 HUD Pro 2.0 模板渲染异常 (KeyError: ' background-color')。
# 2. 【底层优化】将 HTML 渲染引擎从 .format() 切换为原生的 .replace() 链式调用，彻底剥离 Python 变量解析与前端 CSS/JS 大括号 `{}` 的语法冲突，保障前端代码的纯净与策略的稳定运行。
...
# --- 7. 渲染与输出 HTML ---
        ...
        # 【核心修复】使用原生 replace 替代 format，彻底免疫 CSS/JS 的大括号干扰
