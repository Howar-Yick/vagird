...
# 版本号：CHATGPT-3.13.22.3-MACRO-TP-REANCHOR-CYCLE-GUARD
#
# 更新日志 (v3.13.22.3):
...
LOG_FH = None
LOG_DATE = None
__version__ = 'CHATGPT-3.13.22.3-MACRO-TP-REANCHOR-CYCLE-GUARD'
    ...
    for sym in context.symbol_list:
        ...
        if is_valid_price(price):
            ...
            if macro_tp_triggered:
                info('[{}] ⏭ 宏观止盈重锚已完成，本轮跳过 VA/网格单位调整，等待下一轮从新底仓继续。', dsym(context, sym))
                continue
