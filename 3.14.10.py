...
# 版本号：CHATGPT-3.14.10-MACRO-TP-ARMED-TIER-FIX
# [v3.14.10 更新]
# - 修复宏观止盈 Tier 已武装后，价格回落到 Tier 触发线以下时，回撤止盈不触发的问题。
# - 宏观止盈触发判断改为使用 state 中已经武装的 _tp_tier。
# - 不修改 3.14.9 日内单边吞仓压力控制、stack、VA、滴灌、FillPatrol、守门员和天地锁逻辑。
#
# [v3.14.8 更新]
...
LOG_FH = None
LOG_DATE = None
__version__ = 'CHATGPT-3.14.10-MACRO-TP-ARMED-TIER-FIX'
