...
# 版本号：CHATGPT-3.13.22.7-MACRO-TP-PENDING-GUARD-FIX
#
# 更新日志 (v3.13.22.7):
...
LOG_FH = None
LOG_DATE = None
__version__ = 'CHATGPT-3.13.22.7-MACRO-TP-PENDING-GUARD-FIX'
    ...
    if state.get('_pos_jump_seen_ts') is not None:
        ...
        if not _is_dup_fill(context, key):
            ...
            try:
                ...
                _update_macro_tp_pending_by_amount(context, symbol, state, amount, price, status='8')
            except Exception as e:
        ...
        try:
            ...
            for o in all_orders:
                ...
                if delta > 0.9: 
                    ...
                    _update_macro_tp_pending_by_amount(context, symbol, state, real_amount, trade_price, status='8')
