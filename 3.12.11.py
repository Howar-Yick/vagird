...
#
# 更新日志 (v3.12.11):
# 1. 【高危热修复】修复早盘 `handle_data` 主循环中，因调用 `_check_macro_take_profit` 遗漏 `dt` 参数导致的 TypeError 阻断性崩溃。
# 2. 【平稳重启】修复后策略将立刻接管 09:30 后的网格订单簿，确保全天交易平稳运行。
